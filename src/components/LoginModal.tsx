    ...
    <div className="fixed inset-0 bg-primary/40 backdrop-blur-sm z-[100] flex items-center justify-center p-4 animate-in fade-in duration-200">
      <div className="bg-surface rounded-2xl w-full max-w-md p-8 shadow-xl relative animate-in zoom-in-95 duration-200">
        ...
        <div className="space-y-4">
          ...
          <button className="w-full bg-primary text-on-primary font-mono font-bold uppercase tracking-widest rounded-lg py-3 hover:bg-inverse-surface transition-colors mt-2 shadow-[4px_4px_0_0_rgba(160,160,160,1)] active:shadow-none active:translate-y-1 active:translate-x-1">
            Log in
          </button>

          <div className="relative flex items-center py-4">
            <div className="flex-grow border-t-2 border-outline-variant"></div>
            <span className="flex-shrink-0 mx-4 text-on-surface-variant text-sm font-mono font-bold uppercase">or</span>
            <div className="flex-grow border-t-2 border-outline-variant"></div>
          </div>

          <button className="w-full border-2 border-outline-variant text-primary rounded-lg py-3 font-mono font-bold uppercase tracking-widest hover:bg-surface-container transition-colors flex items-center justify-center gap-3">
